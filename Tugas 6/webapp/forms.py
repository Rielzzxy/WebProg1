...
from webapp.models import AccountUser
...
class StudentRegisterForm(forms.Form):
    ...
    nim = forms.CharField(label='Nim', label_suffix=" : ", required=True, widget=forms.TextInput(
            attrs={'class': 'form-control', 'placeholder': '102988444'}),
        help_text="nomor induk mahasiswa", error_messages={'required': "Harus Diisi"})
    email = forms.CharField(label='email', label_suffix=" : ", required=True, widget=forms.TextInput(
