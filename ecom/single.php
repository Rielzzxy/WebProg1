...
<body>
	...
	<!-- //navigation -->
	<!-- banner -->
	<div class="banner banner10" style="background: url('images/banner1.png') no-repeat center; background-size: cover;">
		<div class="container">
		...
		<div class="container">
            ...
            <!--Start-->
                    ...
                    <div class="col-md-8 single-right">
						...
						<p><i class="item_price">Rp <?php echo number_format($info['price'], 0, ',', '.'); ?></i></p>
