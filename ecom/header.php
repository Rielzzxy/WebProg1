    ...
    <body>
        ...
        <div class="header" id="home1">
            <div class="container">
                ...
                <?php endif; ?>
                <div class="w3l_logo">
                    <h1><a href="index.php">Jaket Branded Store<span>Your Trusted Jacket Shop</span></a></h1>
                </div>
                        ...
                        <?php
                            ...
                            if ($id) {
                                while ($pri = $id->fetch_assoc()) {
                                    echo "<script>window.location = 'single.php?proid=" . $pri['proid'] . "'</script>";
                                }
                            } else {
                                echo "<script>alert('Product not found or an error occurred.');</script>";
                            }
                        ?>
                    <?php endif;  ?>
        ...
        <!-- Banner Section -->
        <div class="banner">
            <img src="images/banner2.png" alt="Opening Banner" class="img-fluid" style="width: 100%; height: auto;">
        </div>
        <!-- //Banner Section -->
    </body>
</html>