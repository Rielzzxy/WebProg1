...
?>
    ...
    <div class="header" id="home1">
        <div class="container">
            <div class="w3l_logo">
                <h1><a href="index.php">Jaket Branded Store
                    <span>Your Trusted Jacket Shop</span></a></h1>
            </div>
            <div class="search">
                                ...
                                <tbody>
                                    <?php while ( $allCart = $allCartProduct->fetch_assoc() ): $i++; ?>
                                        <tr>
                                            ...
                                            <td class="text-center">Rp <?php echo number_format($allCart['price'] , 0, ',', '.'); ?></td>
                                            <td class="text-center"><?php echo $allCart['quantity']; ?></td>
                                            <td class="text-center">Rp <?php echo number_format($allCart['quantity']*$allCart['price'] , 0, ',', '.'); $total += $allCart['quantity']*$allCart['price']; ?></td>
                ...
                <?php else: ?>
                    <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4 pull-right hover">
                        <div class="cart-info" style="background-color: #d9edf7; padding: 15%;box-shadow: 5px 4px 18px #888888;border-radius: 3%; font-weight: 700">
                            <p> Total Harga : Rp <?php echo number_format($total , 0, ',', '.'); Session::set("total", $total); ?> </p>
                        </div>
